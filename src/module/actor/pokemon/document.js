...
class PTUPokemonActor extends PTUActor {
    ...
    prepareDerivedData() {
        ...
        this.attributes.level.cap = {
            ...
            training: calcLevelCap(0), // The EXP Training Level Cap is based on the Level Cap without Friendship, it's the max level a Pokemon can reach through EXP Training
            amount: calcExpTrainingCap(), // The amount a Pokemon can gain from Daily EXP Training
        }
